module "lambda_new_view6" {
  source  = "terraform-aws-modules/lambda/aws"
  version = "7.7.1"
  function_name = "${local.base_name}-new_view6"
  role_name     = "rol-${local.base_name}-new_view6"
  handler       = "testHandler"
  runtime       = "java17"
